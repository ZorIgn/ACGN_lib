...
class Sources(models.TextChoices):
    ...
    BANGUMI = "bangumi", "Bangumi 番组计划"
    STEAM = "steam", "Steam"
    WEBNOVEL = "webnovel", "QQ 阅读"
...
class Item(CalendarTriggerMixin, models.Model):
    ...
    def fetch_releases(self, delay):
        ...
        if getattr(settings, "NATIVE_RUNTIME", False):
            return
...
class LibraryLink(models.Model):
    """A private viewing or reading link associated with a work."""
...
class SteamConnection(models.Model):
    """Local credentials and the result of the owner's Steam sync."""

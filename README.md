...
- 📚 **统一收藏** —— 在同一书架管理小说、漫画、动画、剧集、电影和游戏，支持多种类型、多种状态与名称组合筛选，勾选即更新结果。
- 🔎 **名称检索** —— 从 Bangumi、TMDB 和 QQ 阅读获取可用的作品资料与封面，也支持按名称创建自定义条目。
- 🧭 **个性化发现** —— 搜索框下根据书架、评分和作品资料推荐，结合公开热度与题材多样性排序；可切换热门作品，选中后进入导入清单。
...
每张卡片附有推荐理由，资料源评分与自己的星级评分分开展示。点击「加入清单」后可填写个人记录，再确认加入书架。推荐单独加载，资料源暂时不可用时仍可继续搜索。
